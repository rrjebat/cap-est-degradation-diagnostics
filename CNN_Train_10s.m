function [convnet ,info, X_train, X_val, Y_train, Y_val] = CNN_Train_10s(data_size, X, Y, trainInd, valInd, no_cnn_filter1, no_cnn_filter2, no_cnn_filter3,...
    size_filter1, size_filter2, size_filter3, no_fc1, no_fc2)
